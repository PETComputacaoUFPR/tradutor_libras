...
from transformations import vectorial3D
...
for observation in data["features"]:
    new_features.append(vectorial3D(observation))
...
f = open('smv_vectorial3D.p', 'wb')
pickle.dump({'model': model}, f)
f.close()
joblib.dump(scaler, "scaler_vectorial3D.joblib")
